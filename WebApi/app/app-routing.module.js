...
var empty_component_1 = require("./empty/empty.component");
var nav_component_1 = require("./nav/nav.component");
var create_chat_component_1 = require("./createChat/create-chat.component");
var not_selected_chat_component_1 = require("./notSelectedChat/not-selected-chat.component");
var routes = [
    ...
    { path: 'createChat/:id', component: create_chat_component_1.CreateChatComponent, outlet: 'general' },
    { path: '', component: empty_component_1.EmptyComponent, outlet: 'primary' },
    ...
    { path: '**', component: not_found_component_1.NotFoundComponent, outlet: 'primary' },
    { path: 'noChat', component: not_selected_chat_component_1.NotSelectedChatComponent, outlet: 'general' },
